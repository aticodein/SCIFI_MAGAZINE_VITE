  ...
  return (
    <div className="min-h-screen bg-earth-olive px-4 py-12">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-4xl font-bold text-earth-cream mb-10 text-center">
          ...
          {categories.map((cat, i) => (
            <div
              ...
              className={`flex justify-center col-span-1 ${
                categories.length % 3 === 1 && i === categories.length - 1 ? 'lg:col-start-2' : ''
              }`}
            >
                ...
                >
                  <div className="relative w-full h-full rounded-[1rem] overflow-hidden">
                    ...
                    <div className="relative z-10 flex flex-col justify-center items-center h-full text-center px-6">
                      <h2 className="text-3xl font-bold text-white drop-shadow-md mb-3">
                        {cat.title}
                      </h2>
